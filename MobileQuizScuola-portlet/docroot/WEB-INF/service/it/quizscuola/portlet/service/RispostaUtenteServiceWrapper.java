...
public class RispostaUtenteServiceWrapper implements RispostaUtenteService,
	...
	*/
	...
	public it.quizscuola.portlet.model.RispostaUtente addRispostaUtente(
		...
		long idDomanda) {
		return _rispostaUtenteService.addRispostaUtente(ctx, idRisposta,
			idDomanda);
	}
	...
	public com.liferay.portal.kernel.json.JSONObject addJSONRispostaUtente(
		...
		return _rispostaUtenteService.addJSONRispostaUtente(idUtente,
	...
	public com.liferay.portal.kernel.json.JSONObject removeRispostaUtente(
		...
		return _rispostaUtenteService.removeRispostaUtente(idUtente);
	}

	@Override
	public it.quizscuola.portlet.model.RispostaUtente getRispostaUtente(
		long idDomanda, long idUtente) {
		return _rispostaUtenteService.getRispostaUtente(idDomanda, idUtente);
	}

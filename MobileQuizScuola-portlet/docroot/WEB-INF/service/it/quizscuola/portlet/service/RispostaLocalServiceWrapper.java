...
public class RispostaLocalServiceWrapper implements RispostaLocalService,
	...
	*/
	...
	public it.quizscuola.portlet.model.Risposta addRisposta(
		...
		return _rispostaLocalService.addRisposta(ctx, descRisposta, esatta,
			idDomanda);
	}
	...
	public it.quizscuola.portlet.model.Risposta updateRisposta(
		...
		return _rispostaLocalService.updateRisposta(ctx, idDomanda, idRisposta,
			descRisposta, esatta);
	}
	...
	public java.util.List<it.quizscuola.portlet.model.Risposta> getRispostas(
		long idDomanda)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _rispostaLocalService.getRispostas(idDomanda);
	}

	@Override
	public com.liferay.portal.kernel.json.JSONObject getRisultatiDomande(
		long idUtente, long idArgomento) {
		return _rispostaLocalService.getRisultatiDomande(idUtente, idArgomento);
	}

	@Override
	public com.liferay.portal.kernel.json.JSONArray getRisultati(
		long idUtente, long idArgomento) {
		return _rispostaLocalService.getRisultati(idUtente, idArgomento);
	}

 ...
 * @generated
 */
public class ClasseLocalServiceClp implements ClasseLocalService {
	public ClasseLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public it.quizscuola.portlet.model.Classe addClasse(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(classe) });
		}
		catch (Throwable t) {
		...
		return (it.quizscuola.portlet.model.Classe)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.quizscuola.portlet.model.Classe> getClasses(
		...
		return (java.util.List<it.quizscuola.portlet.model.Classe>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.quizscuola.portlet.model.Classe addClasse(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					ClpSerializer.translateInput(descClasse)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.quizscuola.portlet.model.Classe updateClasse(long idClasse,
		...
		try {
			...
			if (t instanceof it.quizscuola.portlet.NoSuchClasseException) {
				throw (it.quizscuola.portlet.NoSuchClasseException)t;
			}

...
/**
 * Provides the local service interface for Materia. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Salvatore
 * @see MateriaLocalServiceUtil
...
public interface MateriaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MateriaLocalServiceUtil} to access the materia local service. Add custom service methods to {@link it.quizscuola.portlet.service.impl.MateriaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

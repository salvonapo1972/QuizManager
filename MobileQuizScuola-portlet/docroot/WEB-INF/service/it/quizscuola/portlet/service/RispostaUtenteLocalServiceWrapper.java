...
public class RispostaUtenteLocalServiceWrapper
	...
	*/
	...
	public it.quizscuola.portlet.model.RispostaUtente addRispostaUtente(
		...
		long idDomanda) {
		return _rispostaUtenteLocalService.addRispostaUtente(ctx, idRisposta,
			idDomanda);
	}
	...
	public com.liferay.portal.kernel.json.JSONObject removeRispostaUtente(
		long idUtente)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _rispostaUtenteLocalService.removeRispostaUtente(idUtente);
	}

	@Override
	public it.quizscuola.portlet.model.RispostaUtente getRispostaUtente(
		long idDomanda, long idUtente) {
		return _rispostaUtenteLocalService.getRispostaUtente(idDomanda, idUtente);
	}

	@Override
	public com.liferay.portal.kernel.json.JSONObject addJSONRispostaUtente(
		long idUtente, long idRisposta, long idDomanda) {
		return _rispostaUtenteLocalService.addJSONRispostaUtente(idUtente,

...
/**
 * Provides the local service interface for Classe. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Salvatore
 * @see ClasseLocalServiceUtil
...
public interface ClasseLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClasseLocalServiceUtil} to access the classe local service. Add custom service methods to {@link it.quizscuola.portlet.service.impl.ClasseLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

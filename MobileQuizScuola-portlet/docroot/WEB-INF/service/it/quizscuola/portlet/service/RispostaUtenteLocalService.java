...
/**
 * Provides the local service interface for RispostaUtente. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Salvatore
 * @see RispostaUtenteLocalServiceUtil
...
public interface RispostaUtenteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RispostaUtenteLocalServiceUtil} to access the risposta utente local service. Add custom service methods to {@link it.quizscuola.portlet.service.impl.RispostaUtenteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the remote service interface for Classe. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Salvatore
 * @see ClasseServiceUtil
...
public interface ClasseService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClasseServiceUtil} to access the classe remote service. Add custom service methods to {@link it.quizscuola.portlet.service.impl.ClasseServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

 ...
 * @generated
 */
public class RispostaLocalServiceClp implements RispostaLocalService {
	public RispostaLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName25 = "getRispostas";

		_methodParameterTypes25 = new String[] { "long" };

		_methodName26 = "getRisultatiDomande";

		_methodParameterTypes26 = new String[] { "long", "long" };

		_methodName27 = "getRisultati";
	...
	public it.quizscuola.portlet.model.Risposta addRisposta(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(risposta) });
		}
		catch (Throwable t) {
		...
		return (it.quizscuola.portlet.model.Risposta)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.quizscuola.portlet.model.Risposta createRisposta(long idRisposta) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { idRisposta });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.quizscuola.portlet.model.Risposta deleteRisposta(long idRisposta)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { idRisposta });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.quizscuola.portlet.model.Risposta fetchRisposta(long idRisposta)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { idRisposta });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.quizscuola.portlet.model.Risposta getRisposta(long idRisposta)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName13,
					_methodParameterTypes13, new Object[] { idRisposta });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.quizscuola.portlet.model.Risposta> getRispostas(
		...
		return (java.util.List<it.quizscuola.portlet.model.Risposta>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.quizscuola.portlet.model.Risposta addRisposta(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					ClpSerializer.translateInput(descRisposta),
	...
	public it.quizscuola.portlet.model.Risposta updateRisposta(
		...
		try {
			...
			if (t instanceof it.quizscuola.portlet.NoSuchRispostaException) {
				throw (it.quizscuola.portlet.NoSuchRispostaException)t;
			}
	...
	public java.util.List<it.quizscuola.portlet.model.Risposta> getRispostas(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					_methodParameterTypes25, new Object[] { idDomanda });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.portal.kernel.json.JSONObject getRisultatiDomande(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName26,
					...
					new Object[] { idUtente, idArgomento });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

 ...
 * @generated
 */
public class RispostaServiceClp implements RispostaService {
	public RispostaServiceClp(InvokableService invokableService) {
		...
		_methodName4 = "getRisultati";

		_methodParameterTypes4 = new String[] { "long", "long" };

		_methodName5 = "getRisultatiDomande";

		_methodParameterTypes5 = new String[] { "long", "long" };

		_methodName6 = "getRispostas";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "updateRisposta";
	...
	public java.util.List<it.quizscuola.portlet.model.Risposta> getRispostas(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { idDomanda });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

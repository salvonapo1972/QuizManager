 ...
 * @generated
 */
public abstract class RispostaActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RispostaActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RispostaLocalServiceUtil.getService());
		setClass(Risposta.class);

		setClassLoader(it.quizscuola.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("idRisposta");
	}
}
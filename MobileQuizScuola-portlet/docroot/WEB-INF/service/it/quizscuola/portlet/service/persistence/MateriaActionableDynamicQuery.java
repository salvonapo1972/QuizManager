 ...
 * @generated
 */
public abstract class MateriaActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MateriaActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MateriaLocalServiceUtil.getService());
		setClass(Materia.class);

		setClassLoader(it.quizscuola.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("idMateria");
	}
}
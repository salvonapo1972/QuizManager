...
/**
 * Provides the local service utility for Domanda. This utility wraps
 * {@link it.quizscuola.portlet.service.impl.DomandaLocalServiceImpl} and is the
 ...
 * @generated
 */
public class DomandaLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.quizscuola.portlet.service.impl.DomandaLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.quizscuola.portlet.model.Domanda addDomanda(
		...
		return getService().addDomanda(domanda);
	}
	...
	*/
	public static it.quizscuola.portlet.model.Domanda createDomanda(
		long idDomanda) {
		return getService().createDomanda(idDomanda);
	}
	...
	*/
	public static it.quizscuola.portlet.model.Domanda deleteDomanda(
		it.quizscuola.portlet.model.Domanda domanda)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDomanda(domanda);
	}
	...
	*/
	...
	public static it.quizscuola.portlet.model.Domanda fetchDomanda(
		long idDomanda)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDomanda(idDomanda);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.Domanda fetchDomandaByUuidAndCompanyId(
		java.lang.String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDomandaByUuidAndCompanyId(uuid, companyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.Domanda fetchDomandaByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDomandaByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.Domanda getDomanda(long idDomanda)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDomanda(idDomanda);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.Domanda getDomandaByUuidAndCompanyId(
		java.lang.String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDomandaByUuidAndCompanyId(uuid, companyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.Domanda getDomandaByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDomandaByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static java.util.List<it.quizscuola.portlet.model.Domanda> getDomandas(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDomandas(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getDomandasCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDomandasCount();
	}
	...
	*/
	public static it.quizscuola.portlet.model.Domanda updateDomanda(
		it.quizscuola.portlet.model.Domanda domanda)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateDomanda(domanda);
	}
	...
	*/
	...
	public static DomandaLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DomandaLocalService.class.getName());

			if (invokableLocalService instanceof DomandaLocalService) {
				_service = (DomandaLocalService)invokableLocalService;
			}
			else {
				_service = new DomandaLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(DomandaLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(DomandaLocalService service) {
	}

	private static DomandaLocalService _service;
}
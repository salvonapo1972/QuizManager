...
/**
 * Provides the local service utility for RispostaUtente. This utility wraps
 * {@link it.quizscuola.portlet.service.impl.RispostaUtenteLocalServiceImpl} and is the
 ...
 * @generated
 */
public class RispostaUtenteLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.quizscuola.portlet.service.impl.RispostaUtenteLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.quizscuola.portlet.model.RispostaUtente addRispostaUtente(
		...
		return getService().addRispostaUtente(rispostaUtente);
	}
	...
	*/
	public static it.quizscuola.portlet.model.RispostaUtente createRispostaUtente(
		long idRispostaUtente) {
		return getService().createRispostaUtente(idRispostaUtente);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.RispostaUtente deleteRispostaUtente(
		long idRispostaUtente)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteRispostaUtente(idRispostaUtente);
	}
	...
	*/
	public static it.quizscuola.portlet.model.RispostaUtente deleteRispostaUtente(
		it.quizscuola.portlet.model.RispostaUtente rispostaUtente)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteRispostaUtente(rispostaUtente);
	}
	...
	*/
	...
	public static it.quizscuola.portlet.model.RispostaUtente fetchRispostaUtente(
		long idRispostaUtente)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchRispostaUtente(idRispostaUtente);
	}
	...
	*/
	public static it.quizscuola.portlet.model.RispostaUtente getRispostaUtente(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getRispostaUtente(idRispostaUtente);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.quizscuola.portlet.model.RispostaUtente> getRispostaUtentes(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getRispostaUtentes(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getRispostaUtentesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getRispostaUtentesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.quizscuola.portlet.model.RispostaUtente updateRispostaUtente(
		it.quizscuola.portlet.model.RispostaUtente rispostaUtente)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateRispostaUtente(rispostaUtente);
	}
	...
	*/
	...
	public static RispostaUtenteLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					RispostaUtenteLocalService.class.getName());

			if (invokableLocalService instanceof RispostaUtenteLocalService) {
				_service = (RispostaUtenteLocalService)invokableLocalService;
			}
			else {
				_service = new RispostaUtenteLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(RispostaUtenteLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(RispostaUtenteLocalService service) {
	}

	private static RispostaUtenteLocalService _service;
}
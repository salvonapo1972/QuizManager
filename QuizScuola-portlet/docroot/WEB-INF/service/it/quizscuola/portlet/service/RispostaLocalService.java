...
/**
 * Provides the local service interface for Risposta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Salvatore
 * @see RispostaLocalServiceUtil
...
public interface RispostaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RispostaLocalServiceUtil} to access the risposta local service. Add custom service methods to {@link it.quizscuola.portlet.service.impl.RispostaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

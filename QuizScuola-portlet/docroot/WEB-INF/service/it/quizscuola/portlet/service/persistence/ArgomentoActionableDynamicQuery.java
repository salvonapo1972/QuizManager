 ...
 * @generated
 */
public abstract class ArgomentoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ArgomentoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ArgomentoLocalServiceUtil.getService());
		setClass(Argomento.class);

		setClassLoader(it.quizscuola.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("idArgomento");
	}
}